...
public class MinuteSchedule extends AbstractSchedule {

    public MinuteSchedule(String filePath, String preFileName, String fileExtension) {
    ...
    protected Runnable run(List<CacheTask> cacheTaskList,ModbusMaster modbusMaster) {
        return () -> cacheTaskList.forEach(t -> {
            ...
            initAndWrite(t, offsetList, results, "yyyyMMdd HHmm");
        });
    }
